...
<form method="get" action="<?=$PHP_SELF?>" name="form1">
				...
				<div class="table_overflow">
					<div class="table_line2 overlayer">
						<table class="board-list" style="min-width:100%;">
							<colgroup>
							...
							<thead>
								<tr>
									<th class="w_cell" rowspan="2">NO</th>
									<th scope="col">신청일</th>
									<th scope="col">진행상태</th>
									<th scope="col">수정처리일</th>
									<th scope="col">청약완료일</th>
									<th scope="col">대표피보험자<br>(신청자)</th>
									<th scope="col">피보험자<br>주민등록번호</th>
									<th scope="col" colspan="3">여행지</th>
								</tr>
								<tr>
									<th scope="col">보험시작일</th>
									<th scope="col">보험종료일</th>
									<th scope="col">플랜명</th>
									<th scope="col">플랜코드</th>
									<th scope="col">보험료</th>
...
?>
								<tr>
									<td class="w_cell" rowspan="2"><?=$article_num?></td>
									...
									<td colspan="3"><a href="view.php?num=<?=$row['plan_hana_no']?>&page=<?=$page?>&make=<?=$make?>&search=<?=$search?>&start_date=<?=$start_date?>&end_date=<?=$end_date?>"><?=$nation_text?></a></td>
								</tr>
								<tr>
