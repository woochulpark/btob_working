...
<div id="wrap">
    ...
    <section id="container">
        <section id="h1">
            ...
            <div><span class="dot">*</span><span class="c_red">표시는 필수로입력하시기 바랍니다.</span></div>
        </section>
        <section id="ac_info">
            <table id="t_info">
                <tbody>
                    <tr>
                        <th>거래처 ID</th>
                        <td class="nb"><?=$_SESSION['s_mem_id']?></td>
                        <th>거래처명</th>
        ...
        <fieldset>
                ...
                <div class="textBox">
                    <div class="write_area">
                        <ul>
                            ...
                            <li class="calendar">
                                <label for=""><span class="dot">*</span><span class="c_red">보험 기간</span></label> 
                                <div>
                                    <span class="day_form">
										<span class="date_picker2">
                                        <input type="text" id="start_date" name="" value="" style="border:0px;height:26px; width: 100px; padding-left: 3px; padding-right: 3px;" readonly ><!-- class="ui-datepicker-trigger hasDatepicker" -->
                                ...
                                <div>
                                    <span class="day_form">
											<span class="date_picker2">
                                        <input type="text" id="end_date" name="" value="" style="border:0px;height:26px; width: 100px; padding-left: 3px; padding-right: 3px;" readonly ><!-- class="ui-datepicker-trigger hasDatepicker" -->
                                        <!--<button type="button" class="ui-datepicker-trigger"><img src="../img/common/ico_s.jpg" alt=" " title=" "></button>-->
										</span>
                                    </span>
                                    <span class="time">
                        ...
                        <ul>
                            <li>
                                <label for=""><span class="dot">*</span><span class="c_red">목적지</span></label>
                ...
                <table id="t_list">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>나이</th>
                            <th><span class="dot">*</span><span class="c_red">직업</span></th>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="checkbox" id="n1" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n2" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n3" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n4" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n5" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n6" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n7" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n8" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n9" name="long_nob[]" value="" />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="n10" name="long_nob[]" value="" />
            ...
            <section id="tt_price_area">
                <div id="check_all">
                    <button type="button" id="long_t_allbt" class="btn_s5">전체 선택</button>
                    <button type="button" id="long_t_allnbt" class="btn_s5">전체 해제</button>
                </div>
