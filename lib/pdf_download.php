...
<?	
	...
	if ($type=="1") {
		$file_name="type_1.pdf";
		$real_file_name="CHUBB 가이드확인서.pdf";
	} elseif ($type=="2") {
		$file_name="type_2.pdf";
		$real_file_name="CHUBB 목격자확인서.pdf";
	} elseif ($type=="3") {
		$file_name="type_3.pdf";
		$real_file_name="CHUBB 보험금청구서.pdf";
	} elseif ($type=="4") {
		$file_name="type_4.pdf";
		$real_file_name="물보험 개인정보 동의서.pdf";
	}  elseif ($type=="5") {
		$file_name="type_5.pdf";
		$real_file_name="물보험 사고 확인서.pdf";
	} elseif ($type=="6") {
		$file_name="type_6.pdf";
		$real_file_name="물보험 청구서.pdf";
	} elseif ($type=="7") {
		$file_name="type_7.pdf";
		$real_file_name="인보험 개인정보 동의서.pdf";
	} elseif ($type=="8") {
		$file_name="type_8.pdf";
		$real_file_name="인보험 청구서.pdf";
	} 

	echo $server_filename = $root_dir."/b2b/lib/".$file_name;
